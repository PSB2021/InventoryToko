...
public class Api {
    ...
    private static final String ROOT_URL = "http://192.168.43.111/InventoryToko/InventoryTokoApi/v1/Api.php?apicall=";
    ...
    public static final String URL_LOGIN_BARANG = ROOT_URL + "login";
